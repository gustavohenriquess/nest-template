...
describe('ValueObject', () => {
  it('should be able to check equality', () => {
    ...
    expect(vo1.equals(null as unknown as ValueObject<StubProps>)).toBe(false);
    expect(vo1.equals(undefined as unknown as ValueObject<StubProps>)).toBe(
      false,
    );
  });
  ...
  it('should handle undefined props in comparison', () => {
    ...
    expect(vo1.equals(vo2 as unknown as ValueObject<StubProps>)).toBe(false);
  });
});
