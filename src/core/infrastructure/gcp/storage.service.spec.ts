...
describe('StorageService', () => {
    ...
    describe('uploadFile', () => {
        ...
        it('should throw error if upload fails', async () => {
            ...
            await expect(service.uploadFile(bucketName, fileName, buffer)).rejects.toThrow(error);
        });
    });
    ...
    describe('downloadFile', () => {
        ...
        it('should throw error if download fails', async () => {
            ...
            await expect(service.downloadFile(bucketName, fileName)).rejects.toThrow(error);
        });
    });
    ...
    describe('deleteFile', () => {
        ...
        it('should throw error if deletion fails', async () => {
            ...
            await expect(service.deleteFile(bucketName, fileName)).rejects.toThrow(error);
        });
    });
});
