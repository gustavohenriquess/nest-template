...
Você DEVE obrigatoriamente seguir a estrutura e metadados definidos na skill `documentation-standard` (incluindo Frontmatter YAML, tags `ai:doc`, `ai:tags`, etc).
Dentro do corpo principal do Markdown, você deve documentar:
...
**Rodapé obrigatório (ao final do arquivo):**
